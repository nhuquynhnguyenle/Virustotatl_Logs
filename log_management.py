...
class log_management:
    ...
    #Method return the logs have destination IP that is not duplicated
    def filterDuplicateIP(self, proxy_logs):
        dict_logs = {}
    ...
    #Test
    def printTestIP(self,logs):
        for log in logs.values():
            print(f"\nIP: {log.IP}\nPort: {log.Port}\nMethod: {log.Method}\nURL: {log.URL}\nDomain: {log.Domain}\nDestinate IP:{log.DestinateIP}")
